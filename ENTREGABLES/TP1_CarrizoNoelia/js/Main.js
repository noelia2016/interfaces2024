...
function onMouseDown(event) {
    ...
    isMouseDown = true; // esta en true mientras el mouse mueva la pieza
...
function onMouseMoved(event) {
    ...
    // mientras este presionando el boton del mouse y tenga una figura seleccionada mueve la misma
...
// cuando suelta el boton del mouse se pone en false
